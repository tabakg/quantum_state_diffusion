...
lambds_dict={R : [0.0, 0.999, 0.99995, 0.999999, 0.9999999]  if R != 0.0 else [0.0] for R in Rs}
                ...
                for delta_t in delta_ts:
                    for seed in SEEDs:
                        for drive_second_system in DRIVES:
                            ...
                            psis_loc_exists = os.path.isfile(psis_loc)
                            psis_loc_exists = os.path.isfile(expects_loc)
                            ...
                            if OVERWRITE or not json_spec_exists or not psis_loc_exists or not psis_loc_exists:
